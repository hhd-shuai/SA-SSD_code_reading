...
def main():
    ...
    # Namespace(config='/home/b516/hhd_shuai/vscode_file/SA-SSD_code_reading/configs/car_cfg.py',
    # gpus=1, launcher='none', local_rank=0, max_ckpt_save_num=10, seed=0, validate=False, work_dir=None)
    args = parse_args()
