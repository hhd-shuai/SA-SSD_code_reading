...
def tensor2points(tensor, offset=(0., -40., -3.), voxel_size=(.05, .05, .1)): # tensor spatial_shape:[20,800,704] spatial_size:11264000,,voxel_size: (0.1, 0.1, 0.2)
    indices = tensor.indices.float()  # indices: torch.Size([54383, 4])
