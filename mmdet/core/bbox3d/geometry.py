...
def remove_outside_points(points, rect, Trv2c, P2, image_shape): #points ndarray：（115384，4）   image_shape[ 370 1224]
    # 5x faster than remove_outside_points_v1(2ms vs 10ms)
    C, R, T = projection_matrix_to_CRT_kitti(P2)
    image_bbox = [0, 0, image_shape[1], image_shape[0]] # [0, 0, 1224, 370]
