...
class KittiLiDAR(Dataset):
    def __init__(self, root, ann_file, #root '/home/b516/hhd_shuai/vscode_file/SA-SSD_code_reading/KITTI/training/' # ann_file '/home/b516/hhd_shuai/vscode_file/SA-SSD_code_reading/KITTI/ImageSets/train.txt'
                 img_prefix,
        ...
        self.img_norm_cfg = img_norm_cfg #{'mean': [123.675, 116.28, 103.53], 'std': [58.395, 57.12, 57.375], 'to_rgb': True}
    ...
    def prepare_train_img(self, idx):
        ...
        # 字典型变量data包含img, img_meta, anchors, voxel(视场范围的点云), coordinates, num_points,
        # anchor_mask, gt_labes, gt_bboxes。
        return data
